...
const WHY = [
  ["pin", "خبرة في المنطقة", "أعمل في يعفور وقرى الشام بريف دمشق، وأعرف عقاراتها وأسعارها عن قرب."],
...
function indexPage(live) {
  ...
  const desc = `أراضٍ وفلل ومزارع وشقق للبيع في يعفور وقرى الشام بريف دمشق. ${live.length} عقاراً متاحاً مع ${NAME}، ${ROLE} — مرافقة من المعاينة حتى التسجيل. واتساب ${PHONE_LOCAL}.`;
  const jsonld = {
